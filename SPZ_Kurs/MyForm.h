...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->вихідToolStripMenuItem->TextAlign = System::Drawing::ContentAlignment::MiddleLeft;
			this->вихідToolStripMenuItem->TextImageRelation = System::Windows::Forms::TextImageRelation::Overlay;
			this->вихідToolStripMenuItem->Click += gcnew System::EventHandler(this, &MyForm::вихідToolStripMenuItem_Click);
			// 
			// проПрограмуToolStripMenuItem
			// 
			this->проПрограмуToolStripMenuItem->ForeColor = System::Drawing::SystemColors::Control;
